...
\fancypagestyle{ExperienceFromAuthor}{
  ...
  \fancyfoot[L]{\thepage} % Page number on the left of the footer
  \fancyfoot[R]{\footnotesize The problem description is written from the personal expierence of the author, who is employed at Schrack Seconet AG, with 7 years of experience in manual and automation testing at the company.} % Footnote text on the right
}
...
In regards to the testing framework used, it is already shown in that Robot Framework can improve the quality of the testing process. \autocite{walkerSoftwareTestAutomation2020}
