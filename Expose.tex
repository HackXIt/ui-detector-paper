...
These studies closely resemble the upcoming research in this thesis in regard to their usage of ML model for gathering metadata about UI, but notably their software applications and user interfaces typically are written in languages and frameworks with better tooling support for performing visual automated testing.
...
All results of the aforementioned studies hint towards an improvement through the usage of ML for visual testing and also the general improvement of quality, due to performing better than manual testing. This serves as a starting point 
